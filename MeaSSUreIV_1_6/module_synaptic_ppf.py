...
class CreateClass(CreateClass_Super):        
    def tab_setup(self):
        ...
        self.EPSC_Pulse_ParamBox = ui.CreateParameterSettingsBoxWithToggle('Pulse setup', 8, 2, layout = "vertical")
        ...
        self.EPSC_Pulse_ParamBox.set_item(6, 'Number of pulses', '2', '#')
        self.EPSC_Pulse_ParamBox.set_item(7, 'Delay between pulses', '100', 'ms')
        
        self.EPSC_GraphBox = ui.CreateGraphBox('PPF characteristics', 2)
        self.EPSC_GraphBox.set_titles(0, 'PPF curves (Ids-Vds)', 'Time (s)', 'Ids (A)')        
        self.EPSC_GraphBox.set_titles(1, 'PPF curves (leakage) (Igs-Vds)', 'Time (s)', 'Igs (A)')
    ...
    def run_measurement_start(self):      
        ...
        self.num_pulses = round(float(self.EPSC_Pulse_ParamBox.le_list[6].text()), ROUNDNUM)
        self.pulse_to_pulse_delay = round(float(self.EPSC_Pulse_ParamBox.le_list[7].text()), ROUNDNUM)

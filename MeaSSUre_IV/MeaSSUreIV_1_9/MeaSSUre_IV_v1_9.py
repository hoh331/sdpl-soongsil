...
import module_reservoir_test, module_pbit_memristor, module_2T0C_operation
import os
...
class App(QWidget):       
    def __init__(self):
        ...
        self.SWInfoBox = ui.CreateSWInfoBox(sw_text = "MeaSSUre: I-V (v1.9 March 2025)",
                                            date_text = "v1.9 beta March 2025",
    ...
    def setup_tabs(self):
        ...
        self.module_list.append(module_pbit_memristor.CreateClass(self))
        self.module_list.append(module_2T0C_operation.CreateClass(self))
    ...
    def tab_change(self, i):
        ...
        elif self.scan_type == "P-bit (Memristor)":
            self.ConnectionControlBox.lbl_list[0].setText("SMU1 (Vread)")
            self.ConnectionControlBox.lbl_list[1].setText("SMU2 (Vref)")
            self.ConnectionControlBox.lbl_list[2].setText("SMU3 (Vout)")
        elif self.scan_type == "2T0C DRAM operation":
            self.ConnectionControlBox.lbl_list[0].setText("SMU1 (WBL)")
            self.ConnectionControlBox.lbl_list[1].setText("SMU2 (RWL)")
            self.ConnectionControlBox.lbl_list[2].setText("SMU3 (WWL)")
        else:

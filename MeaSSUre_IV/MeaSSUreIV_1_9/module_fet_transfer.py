...
class CreateClass(CreateClass_Super):
    def tab_setup(self):
        ...
        self.Transfer_SecondGate_ParamBox = ui.CreateParameterSettingsBoxWithToggle('Second Gate bias setup', 8, 2)
        self.Transfer_SecondGate_ParamBox.set_toggle_item(0, 'Linear steps', False)
        self.Transfer_SecondGate_ParamBox.set_toggle_item(1, 'Custom steps', True)
        self.Transfer_SecondGate_ParamBox.set_item(0, 'Vgs (start)', '5, 10, 20, 30', 'V')
        self.Transfer_SecondGate_ParamBox.set_item(1, 'Vgs stop', '10', 'V')
        self.Transfer_SecondGate_ParamBox.set_item(2, 'Vgs step', '10', 'V')
        self.Transfer_SecondGate_ParamBox.set_item(3, '<Measurement settings>', '0', '0')
        self.Transfer_SecondGate_ParamBox.show_only_name(3)
        self.Transfer_SecondGate_ParamBox.set_item(4, 'Gate trigger delay', '0.01', 's')
        self.Transfer_SecondGate_ParamBox.set_item(5, 'Gate source delay', '0.01', 's')
        self.Transfer_SecondGate_ParamBox.set_item(6, 'Gate NPLC', '1', 'number')
        self.Transfer_SecondGate_ParamBox.set_item(7, 'Current compliance', '100E-3', 'A')
        self.Transfer_SecondGate_ParamBox.groupbox.setCheckable(True)
        self.Transfer_SecondGate_ParamBox.groupbox.setChecked(False)
        ...
        self.tabTransfer_vbox.addWidget(self.Transfer_SecondGate_ParamBox.groupbox)
    ...
    def run_measurement_start(self):        
        ...
        if self.Transfer_SecondGate_ParamBox.groupbox.isChecked():            
            if self.Transfer_SecondGate_ParamBox.rbtn_list[1].isChecked():
                text = self.Transfer_SecondGate_ParamBox.le_list[0].text()
                self.vgs2_list = [float(x) for x in text.split(',')]
                
            else:                
                vgs2_start = round(float(self.Transfer_SecondGate_ParamBox.le_list[0].text()), ROUNDNUM)
                vgs2_stop =  round(float(self.Transfer_SecondGate_ParamBox.le_list[1].text()), ROUNDNUM)
                vgs2_step =  round(float(self.Transfer_SecondGate_ParamBox.le_list[2].text()), ROUNDNUM)     
        ...
        if self.Transfer_SecondGate_ParamBox.groupbox.isChecked():   
            self.SMU_init_params[2].append(round(float(self.Transfer_SecondGate_ParamBox.le_list[-4].text()), ROUNDNUM))
            self.SMU_init_params[2].append(round(float(self.Transfer_SecondGate_ParamBox.le_list[-3].text()), ROUNDNUM))
            self.SMU_init_params[2].append(round(float(self.Transfer_SecondGate_ParamBox.le_list[-2].text()), ROUNDNUM))
            self.SMU_init_params[2].append(round(float(self.Transfer_SecondGate_ParamBox.le_list[-1].text()), ROUNDNUM))

...
class CreateClass(CreateClass_Super):        
    def tab_setup(self):
        ...
        self.PD_External_ParamBox = ui.CreateParameterSettingsBox('External SMU setup', 7)
        self.PD_External_ParamBox.set_item(0, 'External Auto Zero', '0', '0: OFF/1: ON')
        self.PD_External_ParamBox.set_item(1, 'External Voltage source range', '20', 'V')        
        self.PD_External_ParamBox.set_item(2, 'External Current sensing range', '100E-6', 'A')   
        self.PD_External_ParamBox.set_item(3, 'External trigger delay', '0.0', 's')
        self.PD_External_ParamBox.set_item(4, 'External source delay', '0.0', 's')
        self.PD_External_ParamBox.set_item(5, 'External NPLC', '1', 'number')
        self.PD_External_ParamBox.set_item(6, 'Current compliance', '100E-3', 'A')                       
        ...
        self.tab_vbox2.addWidget(self.PD_External_ParamBox.groupbox)      
    ...
    def run_measurement_start(self):      
        ...
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-4].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-3].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-2].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-1].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-7].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-6].text()), ROUNDNUM))
        self.SMU_init_params[2].append(round(float(self.PD_External_ParamBox.le_list[-5].text()), ROUNDNUM))
...
class IO_Thread(IO_Thread_Super):  
    def __init__(self, SMU_list, SMU_init_params, scan_type = None,
                 ...
                 pot_pulse_target = None, dep_pulse_target = None, time_step = None, 
                 pulse_to_pulse_delay = None, num_pulses = None, **kwargs):
        ...
        self.pot_pulse_target = pot_pulse_target
        self.dep_pulse_target = dep_pulse_target
        ...
        self.dep_pulse_num = kwargs.get("dep_pulse_num")
        self.dep_pulse_amp = kwargs.get("dep_pulse_amp")
        self.dep_pulse_width = kwargs.get("dep_pulse_width")

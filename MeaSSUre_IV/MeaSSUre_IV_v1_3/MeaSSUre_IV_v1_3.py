...
import time
import numpy as np
import MeaSSUre_IV_UI_all_v1_3 as ui
import os
...
class App(QWidget):       
    ...
    def setup_tabs(self):
        ...
        self.Memory_Endurance_ParamBox.set_item(8, 'Drain NPLC', '0.1', 'number')
        ...
        self.Memory_Retention_ParamBox.set_item(8, 'Drain NPLC', '0.1', 'number')
...
class IO_Thread(QtCore.QThread):
    ...
    def __init__(self, SMU_list, SMU_init_params, scan_type = None,
                 ...
                 repeat_num = None, pulse_width = None, parent = None):

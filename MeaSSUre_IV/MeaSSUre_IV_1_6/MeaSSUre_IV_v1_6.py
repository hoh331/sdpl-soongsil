...
import time
import numpy as np
import MeaSSUre_IV_UI_all_v1_6 as ui
import module_fet_output, module_fet_transfer, module_PBSNBS
import module_IV, module_collector, module_memory_endurance
import module_fet_i_t, module_synaptic_epsc, module_synaptic_ppf, module_synaptic_pd
import os
...
class App(QWidget):       
    def __init__(self):
        ...
        self.SWInfoBox = ui.CreateSWInfoBox(sw_text = "MeaSSUre: I-V (v1.6 September 2023)",
                                            date_text = "v1.6 beta September 2023",
    ...
    def setup_tabs(self):
        ...
        self.module_list.append(module_synaptic_epsc.CreateClass(self))
        self.module_list.append(module_synaptic_ppf.CreateClass(self))

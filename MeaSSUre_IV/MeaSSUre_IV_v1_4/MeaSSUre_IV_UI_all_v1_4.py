...
class CreateParameterSettingsBoxWithToggle:
    def __init__(self, title = 'Parameter Settings Box', num_parameter = 5, num_toggle = 2):
        self.groupbox = QGroupBox(title)
...
class TimeDisplayBox():
    def __init__(self):        
        ...
        font_medium = QFont('Arial', 16, QFont.Bold)
        self.groupbox = QGroupBox('Time Display:')
        self.vbox_time_display = QVBoxLayout()
        ...
        self.vbox_time_display.addWidget(self.lbl_current_time_label)
        self.vbox_time_display.addWidget(self.lbl_current_time)
        self.vbox_time_display.addWidget(self.lbl_recording_time_label)
        self.vbox_time_display.addWidget(self.lbl_recording_time)
        self.groupbox.setLayout(self.vbox_time_display)
        self.lbl_current_time.setFont(font_medium)
        self.lbl_recording_time.setFont(font)
